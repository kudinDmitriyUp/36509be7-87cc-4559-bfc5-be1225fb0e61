...
export const metadata: Metadata = {
  title: "LearnHub - Transform Your Skills with AI-Powered Learning",
  description: "Master IT and creative skills through personalized courses, interactive projects, and expert mentorship on our cutting-edge learning platform. Join 50K+ students worldwide.",
  keywords: "online learning, AI-powered education, IT courses, creative skills, web development, data science, UX design, digital marketing, programming courses",
  openGraph: {
    title: "LearnHub - Transform Your Skills with AI-Powered Learning",
    description: "Master IT and creative skills through personalized courses, interactive projects, and expert mentorship on our cutting-edge learning platform.",
    siteName: "LearnHub",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35bov8zjOkdGcVDNMecOsQMxHeM/uploaded-1763395978799-60gtpcil.jpg",
        alt: "LearnHub learning platform dashboard"
      }
    ]
  },
  twitter: {
    ...
    title: "LearnHub - Transform Your Skills with AI-Powered Learning",
    description: "Master IT and creative skills through personalized courses, interactive projects, and expert mentorship on our cutting-edge learning platform.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35bov8zjOkdGcVDNMecOsQMxHeM/uploaded-1763395978799-60gtpcil.jpg"]
  },
  robots: {
    index: true,
    follow: true
